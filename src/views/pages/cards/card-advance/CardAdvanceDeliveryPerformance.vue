...
const deliveryData = [
  { title: 'Packages in transit', value: '10k', change: 25.8, icon: 'tabler-package', color: 'primary' },
  ...
  { title: 'Delivery success rate', value: '95%', change: 35.6, icon: 'tabler-rosette-discount', color: 'warning' },
