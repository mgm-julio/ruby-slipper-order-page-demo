...
const resolveCategoryIcon = (value: string) => {
  if (value === 'smartphone')
    return { icon: 'tabler-device-mobile', color: 'primary' }

  else if (value === 'mouse')
    return { icon: 'tabler-mouse', color: 'warning' }

  else if (value === 'computer')
    return { icon: 'tabler-device-desktop', color: 'info' }

  else if (value === 'smart-tv')
    return { icon: 'tabler-device-tv', color: 'error' }
