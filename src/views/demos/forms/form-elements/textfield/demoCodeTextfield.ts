...
<template>
  <AppTextField
    ...
    color="primary"
    placeholder="Hey!!"
    clear-icon="tabler-x-circle"
    :append-icon="message ? $vuetify.locale.isRtl ? 'tabler-arrow-bar-left' : 'tabler-arrow-bar-right' : 'tabler-microphone'"
    :append-inner-icon="marker ? 'tabler-alarm' : 'tabler-alarm-off'"
