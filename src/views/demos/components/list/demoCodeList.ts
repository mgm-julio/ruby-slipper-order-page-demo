...
const items = [
  ...
  { title: 'Shared with me', value: 2, prependIcon: 'tabler-user' },
...
const items = [
  ...
  },
  {
    ...
    value: 3,
    props: {
      prependIcon: 'tabler-brand-whatsapp',
      rounded: 'xl',
    },
  },
  {
...
const files = [
  {
    color: 'blue',
    icon: 'tabler-home-alt-2',
    subtitle: 'Jan 20, 2014',
    title: 'Vacation itinerary',
  },
  {
    color: 'amber',
    icon: 'tabler-camera-home',
