      ...
      <VContainer>
        <div class="d-flex justify-space-between flex-wrap gap-y-5 align-center">
          ...
          <div class="d-flex gap-x-4 text-body-1">
            <template
              v-for="(item, index) in [
                { title: 'github', icon: 'tabler-brand-github', href: 'https://github.com/themeselection' },
                { title: 'facebook', icon: 'tabler-brand-facebook', href: 'https://www.facebook.com/ThemeSelections/' },
                { title: 'twitter', icon: 'tabler-brand-twitter', href: 'https://x.com/Theme_Selection' },
                { title: 'google', icon: 'tabler-brand-google', href: 'https://www.themeselection.com' },
              ]"
              :key="index"
            >
              <IconBtn
