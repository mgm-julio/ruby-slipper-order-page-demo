...
const vehicleData = [
  { icon: 'tabler-truck', title: 'On the way', time: '2hr 10min', percentage: 39.7 },
  { icon: 'tabler-circle-arrow-up', title: 'Unloading', time: '3hr 15min', percentage: 28.3 },
  { icon: 'tabler-circle-arrow-down', title: 'Loading', time: '1hr 24min', percentage: 17.4 },
