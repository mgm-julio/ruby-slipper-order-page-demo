...
const resolveUserRoleVariant = (role: string) => {
  ...
  if (role === 'maintainer')
    return { color: 'primary', icon: 'tabler-chart-pie' }
  if (role === 'editor') return { color: 'info', icon: 'tabler-pencil' }
  if (role === 'admin') return { color: 'secondary', icon: 'tabler-server' }
          ...
          >
            ...
            <div class="d-flex align-center me-4">
              <VAvatar
                ...
                class="me-4"
              >
                <VIcon icon="tabler-apps" size="24" />
              </VAvatar>
              <div>
                <h5 class="text-h5">
          ...
          <VList class="card-list">
            <VListItem v-for="benefit in standardPlan.benefits" :key="benefit">
              <div class="d-flex align-center gap-x-2">
                <VIcon size="6" color="secondary" icon="tabler-circle-filled" />
