...
const widgetData = [
  ...
  { title: 'Conversion Rate', value: '4.5%', icon: 'tabler-infinite', color: 'info' },
]

const stepsData = [
  { icon: 'tabler-rocket', desc: 'Create & validate your referral link and get', value: '$50' },
  { icon: 'tabler-user-dollar', desc: 'For every new signup you get', value: '10%' },
  { icon: 'tabler-send', desc: 'Get other friends to generate link and get', value: '$100' },
]
