...
const widgetData = ref([
  { title: 'Pending Payment', value: 56, icon: 'tabler-calendar' },
  { title: 'Completed', value: 12689, icon: 'tabler-check-double' },
  { title: 'Refunded', value: 124, icon: 'tabler-wallet' },
  { title: 'Failed', value: 32, icon: 'tabler-exclamation-circle' },
])
