...
const inventoryTabsData = [
  { icon: 'tabler-box', title: 'Restock', value: 'Restock' },
  { icon: 'tabler-truck', title: 'Shipping', value: 'Shipping' },
  { icon: 'tabler-globe', title: 'Global Delivery', value: 'Global Delivery' },
  { icon: 'tabler-link', title: 'Attributes', value: 'Attributes' },
