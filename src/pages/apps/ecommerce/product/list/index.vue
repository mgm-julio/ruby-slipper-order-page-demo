...
const widgetData = ref([
  { title: 'In-Store Sales', value: '$5,345', icon: 'tabler-building-store', desc: '5k orders', change: 5.7 },
  { title: 'Website Sales', value: '$74,347', icon: 'tabler-device-laptop', desc: '21k orders', change: 12.4 },
...
const resolveCategory = (category: string) => {
  if (category === 'Accessories')
    return { color: 'error', icon: 'tabler-headphones' }
  if (category === 'Home Decor')
    return { color: 'info', icon: 'tabler-home-smile' }
  if (category === 'Electronics')
    return { color: 'primary', icon: 'tabler-device-laptop' }
  if (category === 'Shoes')
    return { color: 'success', icon: 'tabler-walk' }
  if (category === 'Office')
    return { color: 'warning', icon: 'tabler-briefcase' }
  if (category === 'Games')
    return { color: 'primary', icon: 'tabler-device-gamepad' }
}
