...
const widgetData = ref([
  ...
  { title: 'Invoices', value: 165, icon: 'tabler-file' },
  { title: 'Paid', value: '$2.46k', icon: 'tabler-check-double' },
  { title: 'Unpaid', value: '$876', icon: 'tabler-exclamation-circle-circle' },
])
...
const resolveInvoiceStatusVariantAndIcon = (status: string) => {
  ...
  if (status === 'Past Due')
    return { variant: 'error', icon: 'tabler-help-circle' }
...
const computedMoreList = computed(() => {
  return (paramId: number) => ([
    ...
    { title: 'Duplicate', value: 'duplicate', prependIcon: 'tabler-copy-plus' },
  ])
})
